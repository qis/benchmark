...
set(TOOLCHAIN_TEXT "MSVC, MS STL, SPEED, EXCEPTIONS DISABLED" CACHE STRING "")
set(TOOLCHAIN_HAS_COROUTINES ON CACHE STRING "")
set(TOOLCHAIN_HAS_EXCEPTIONS OFF CACHE STRING "")
...
if(NOT _CMAKE_IN_TRY_COMPILE)
  set(MSVC_FLAGS "/arch:AVX2 /fp:fast /Zc:strictStrings /Zc:char8_t /utf-8")
  set(MSVC_FLAGS_RELEASE "/O1 /Oi /GS- /MT /DNDEBUG")
  ...
  set(CMAKE_C_FLAGS_RELEASE "${MSVC_FLAGS_RELEASE}" CACHE STRING "")
  set(CMAKE_CXX_FLAGS_RELEASE "${MSVC_FLAGS_RELEASE} /await /await:heapelide" CACHE STRING "")
  ...
  set(CMAKE_SHARED_LINKER_FLAGS_RELEASE "/LTCG /DEBUG:NONE /OPT:REF /OPT:ICF" CACHE STRING "")
  set(CMAKE_EXE_LINKER_FLAGS_RELEASE "/LTCG /DEBUG:NONE /OPT:REF /OPT:ICF" CACHE STRING "")
